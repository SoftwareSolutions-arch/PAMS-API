...
import { getDeposits, createDeposit, updateDeposit, deleteDeposit ,getDepositsByAccount ,getDepositsByDateRange} from "../controllers/depositController.js";
...
router.post("/", protect, allowRoles("Agent"), createDeposit);
